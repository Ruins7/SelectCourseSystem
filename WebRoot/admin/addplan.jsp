...
<html>
  <head>
    <title>admin add plan page</title>
...
-->
  ...
  <s:form action="addplan.action" method="post">
     ...
     学位类型：<s:select list="{'工学','理学','文学','法学','商学','医学'}" name="plan.degree" id="4" value="'工学'"/><br>
     培养层次：<s:select list="{'本科','硕士','博士'}" name="plan.eduLevel" id="5" value="'本科'"/><br>
     方向：<s:textfield name="plan.direction" id="6"/><br>
     学分要求：<s:textfield name="plan.minCredit" id="7"/><br>
     <s:submit value="添加培养计划"/><br>
  </s:form>
