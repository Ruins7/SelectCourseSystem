...
<html>
  <head>
    <title>admin update teacher page</title>
...
-->
  ...
  <s:form action="updateteacher.action" method="post">
     ...
     电子邮箱：<s:textfield id="6" name="teacher.teaEmail" />
       <input type="hidden" name="teacher.teacherID" value="<s:property value="teacherid"/>">
			<s:submit value="确认修改" />
			<br>
		</s:form>
		<br><br><hr>
