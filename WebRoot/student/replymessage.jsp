...
<html>
<head>
		<title>student reply message page</title>
...
-->
  ...
  <div id="content">
     <div id="contentlift">
		...
		<h2 class="a">与<s:property value="allmessage[0].fromStudentName"/>的对话：</h2><br/>
		<s:iterator value="allmessage">
		    <s:property value="allmessage[0].fromStudentName"/>&nbsp;&nbsp;说&nbsp;&nbsp;<s:property value="content"/><br/><br/>
		    在：<s:property value="timeOfLeaMes"/><br/><br/><br/>
		</s:iterator>
		
		<s:form action="writereply.action" method="post">
		<s:textarea id="1" name="sme.content" rows="7" cols="50"/>
		  <input type="hidden" name="beiID"
		value="<s:property value= "allmessage[0].fromStudentID" /> " />
